 ...
 */
public class CharacterJava implements Repr<CharacterJava>, Jsonic<CharacterJava> {
     ...
     *
     * @see #Character(DemographicsJava, NameJava, MunicipalityJava, MunicipalityJava, MunicipalityJava,
     *      Date, CharacterModel)
     */
    public CharacterJava(CharacterManager cm, DemographicsManager dm, MapManager mm, NameManager nm) {
     ...
     */
    public CharacterJava(CharacterJava other) {
        this.demographics = new DemographicsJava(other.demographics);
        this.name = new NameJava(other.name);
     ...
     *                           object to the CharacterManager's list.
     */
    public CharacterJava(String buildstring) {
     ...
     */
    public CharacterJava(JSONObject json) {
        if (json == null) {
    ...
    public CharacterJava(
        ...
        NameJava name,
        MunicipalityJava birthplaceMunicipality,
        MunicipalityJava residenceMunicipality,
        LocalDate birthday,
    ...
    public CharacterJava(
        ...
        NameJava name,
        MunicipalityJava birthplaceMunicipality,
        MunicipalityJava currentLocationMunicipality,
        MunicipalityJava residenceMunicipality,
        LocalDate birthday,
        CharacterModel appearance
    ) {
    ...
    public DemographicsJava getDemographics() {
        return this.demographics;
    }

    public void setDemographics(DemographicsJava demographics) {
        this.demographics = demographics;
    }

    // Name

    public NameJava getName() {
        return this.name;
    }

    public void setName(NameJava name) {
        this.name = name;
    }

    // Birthplace : Municipality

    public MunicipalityJava getBirthplaceMunicipality() {
        return this.birthplaceMunicipality;
    }

    public void setBirthplaceMunicipality(MunicipalityJava birthplace) {
        this.birthplaceMunicipality = birthplace;
    }

    // Current Location : Municipality

    public MunicipalityJava getCurrentLocationMunicipality() {
        return this.currentLocationMunicipality;
    }

    public void setCurrentLocationMunicipality(MunicipalityJava currentLocation) {
        this.currentLocationMunicipality = currentLocation;
    }

    // Residence : Municipality
    public MunicipalityJava getResidenceMunicipality() {
        return this.residenceMunicipality;
    }

    public void setResidenceMunicipality(MunicipalityJava residence) {
    ...
    @Override
    public CharacterJava fromRepr(String repr) {
        return this;
    }
    ...
    @Override
    public CharacterJava fromJson(JSONObject json) {
        ...
        if (demographicsObj instanceof JSONObject demographicsJson)
            this.demographics = new DemographicsJava(demographicsJson);
        // Name
        Object nameObj = json.get("name");
        if (nameObj instanceof JSONObject nameJson)
            this.name = new NameJava(nameJson);
        // Birthplace
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || this.getClass() != obj.getClass())
            return false;
        CharacterJava other = (CharacterJava) obj;
    ...
    @Override
    public CharacterJava clone() {
        return new CharacterJava(this);
    }
}
