/*
 * Political Actor
 * ~/characters/PoliticalActor.java
 * Steven LaGoy
...
/**
 * A Character subclass which represents a Character who may interact with
 * political systems, like leaders, lobbyists, or candidates.
 * <p>
 * Contains fields and methods which describe a PoliticalActor's alignments and
 * positions.
 *
 * @see CharacterJava
 * @see HasPersonality
 */
public class PoliticalActorJava extends CharacterJava {
    ...
    public static final int MAX_AGE = CharacterJava.MAX_AGE;
    ...
    public static enum Education {
         ...
         * {@code 0}
         * <p>
         * Early Childhood Education: For children younger than three years through
         ...
         * {@code 1}
         * <p>
         * Primary Education: Core knowledge in Reading, Writing, and Mathematics.
         * Elementary School (K/1 - 5/6).
         */
        PRIMARY(1),
        /**
         * {@code 2}
         * <p>
         * Lower Secondary Education: English, Science, Social Studies, and Algebra.
         * Middle School (5/6 - 8/9)
         */
        LOWER_SECONDARY(2),
        /**
         * {@code 3}
         * <p>
         * Upper Secondary Education: Language, Political Science, Higher Sciences,
         * Higher Mathematics. High School (9 - 12)
         */
        UPPER_SECONDARY(3),
        /**
         * {@code 4}
         * <p>
         * Post-Secondary Non-Tertiary Education: Vocational or Technical Skills,
         * Certifications.
         */
        POST_SECONDARY(4),
        /**
         * {@code 5}
         * <p>
         * Short-Cycle Tertiary Education: Any amount of a practically-based
         * occupationally-specific concentrated education program.
         */
        SHORT_TERTIARY(5),
        /**
         * {@code 6}
         * <p>
         * Bachelor's Degree or Equivalent: Intermediate academic or professional
         ...
         * {@code 7}
         * <p>
         * Master's Degree or Equivalent: Advanced academic or professional knowledge,
         ...
         * {@code 8}
         * <p>
         * Doctorate or Equivalent: Advanced research qualification, usually with
         * submission and defense of a substantive dissertation.
         */
        DOCTORAL(8);
    ...
    /**
     * An int array of two values between -100 and +100, where alignments[0] gives
     * authoritarian (+)
     * and liberatarian (-) leaning, and alignments[1] gives left (-) and right (+)
     * leaning. Based on
    ...
    /**
     * A Skills object representing the legislative, executive, and judicial skills
     * (and aptitude) of this PoliticalActor.
     */
    protected SkillsJava skills;
     ...
     *
     * @see CharacterJava#CharacterJava()
     */
    public PoliticalActorJava(CharacterManager cm, DemographicsManager dm, MapManager mm, NameManager nm) {
        this(new CharacterJava(cm, dm, mm, nm));
    }
     ...
     */
    public PoliticalActorJava(PoliticalActorJava other) {
        super(other);
        ...
        this.skills = (SkillsJava) other.skills.clone();
        ...
        this.roles = new HashSet<PoliticalRole>() {{
            add(PoliticalRole.NONE);
        }};
    }

    /**
     * Creates a PoliticalActor by deep-copying the fields of the passed Character
     * object,
     ...
     * @param addToCharacterList Boolean indicating whether to add the created
     *                           object to the CharacterManager's list.
     * @see CharacterJava#CharacterJava(CharacterJava)
     */
    public PoliticalActorJava(CharacterJava character) {
        super(character);
        this.cash = 0;
        this.education = Education.POST_SECONDARY;
        this.alignments = new int[] { 0, 0 };
        this.experiences = new ArrayList<Experience>();
        this.skills = new SkillsJava();
        this.positions = new ArrayList<Position>();
        this.conviction = 100;
     ...
     *                           object to the CharacterManager's list.
     */
    public PoliticalActorJava(String buildstring) {
        super(buildstring);
    ...
    public PoliticalActorJava(JSONObject json) {
        super(json);
        if (json == null) {
     ...
     * Creates a PoliticalActor by deep-copying the fields of the passed Character
     * object,
     * and fills the other fields with the passed values. The CharacterManager will
     * generate
     ...
     * @param alignments  Int array of two values between {@code -100} and
     *                    {@code +100}, which represents the PoliticalActor's
     *                    Auth/Lib and Right/Left alignments.
     * @param experiences List of Experiences representing the experiences of this
     *                    PoliticalActor.
     * @param skills      Skills object representing the skills and aptitude of this
     *                    PoliticalActor.
     * @param positions   List of the positions on issues held by this
     *                    PoliticalActor.
     * @param personality Personality object for this PoliticalActor's personality.
     * @param roles       Set of Roles for this PoliticalActor's roles. If empty or
     *                    null, {@code Role.NONE} will be added.
     */
    public PoliticalActorJava(
        CharacterJava character,
        int cash,
        Education education,
        int[] alignments,
        ...
        Set<PoliticalRole> roles
    ) {
        super(character);
        if (alignments.length != 2)
            throw new IllegalArgumentException(
                    "The alignments int array must have a length of 2, not " + String.valueOf(alignments.length));
        this.cash = cash;
        this.education = education;
        this.alignments = alignments;
        this.conviction = evalConviction();
        this.experiences = experiences != null ? experiences : new ArrayList<Experience>();
        this.skills = skills != null ? skills : new SkillsJava();
        ...
        this.roles = roles != null ? roles : new HashSet<PoliticalRole>() {{
            add(PoliticalRole.NONE);
        }};
    }

    /**
     * Creates a PoliticalActor, filling fields with the passed values. The
     * CharacterManager
     ...
     *                                    this Character.
     * @param cash                        Funds currently usable by this
     *                                    PoliticalActor.
     * @param education                   Highest education level attained by this
     *                                    PoliticalActor.
     * @param alignments                  Int array of two values between -100 and
     *                                    +100, which represents the
     *                                    PoliticalActor's Auth/Lib and Right/Left
     *                                    alignments.
     * @param experiences                 List of Experiences representing the
     *                                    experiences of this PoliticalActor.
     * @param skills                      Skills object representing the skills and
     *                                    aptitude of this PoliticalActor.
     * @param positions                   List of the positions on issues held by
     *                                    this PoliticalActor.
     * @param personality                 Personality object for this
     *                                    PoliticalActor's personality.
     * @param roles                       Set of roles for this PoliticalActor's
     *                                    roles. If empty or null, {@code Role.NONE}
     *                                    will be added.
     * @see CharacterJava#Character(DemographicsJava, NameJava, Municipality, Municipality,
     *      Municipality, Date, CharacterModel)
     * @see #PoliticalActor(CharacterJava, int, Education, int[], List, SkillsJava, List,
     *      Personality, Role)
     */
    public PoliticalActorJava(
        CharacterManager cm,
        ...
        this(new CharacterJava(cm, dm, mm, nm, demographics, name, birthplaceMunicipality, currentLocationMunicipality, residenceMunicipality, birthday, appearance),
    ...
    public void setAuthLibAlignment(int alignment) {
        if (alignment < -100 || alignment > 100)
            throw new IllegalArgumentException(
                    "Alignment values must be between -100 and +100, not " + String.valueOf(alignment));
    ...
    // Skills
    public SkillsJava getSkills() {
        return this.skills;
    }

    public void setSkills(SkillsJava skills) {
        this.skills = skills;
    }

    // Position(s) : List of Position
    public Position getPositionOnIssue(Issue issue) {
        for (Position position : positions) {
            if (position.getRootIssue().equals(issue))
                return position;
        }
        Logger.log("INVALID ISSUE NAME", String.format(
                "An invalid issue name, \"%s\", was supplied. Unable to determine position on non-existant issue.",
                issue), new Exception());
        return null;
    }
    ...
    protected float getAgeMod(TimeManager tm) {
        float ageMod;
        int age = this.getAge(tm);
    ...
    public String toRepr() {
        ...
        String repr = String.format(
                "%s:[%scash=%d;education=%d;alignments=(%d,%d);experiences=[%s];skills:%s;positions=[%s];conviction=%d;ageMod=%f;personality=%s;];",
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || this.getClass() != obj.getClass())
            return false;
        PoliticalActorJava other = (PoliticalActorJava) obj;
    ...
    @Override
    public PoliticalActorJava clone() {
        return new PoliticalActorJava(this);
    }
}
