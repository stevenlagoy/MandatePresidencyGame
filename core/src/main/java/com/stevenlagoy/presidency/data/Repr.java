...
public interface Repr<T extends Repr<T>> {
     ...
     * @return The created object if interpreted properly from the Repr String,
     *         {@code null} otherwise.
     */
    ...
    /**
     * Takes any object and returns a skeleton/blank Repr-format String
     * representation of an instance of that object's class. For a filled version,
     * use the object's toRepr() method.
     * 
     * @param <O>   Object
     * @param clazz Any class
     * @return Skeleton (unfilled) Repr-format String representation of an object of
     *         the class.
     */
    public static <O> String classRepr(Class<O> clazz) {
        String[] singleTypes = { "int", "java.lang.String", "char", "long", "float", "double" }; // All the types that
    ...
    /**
     * Turns an array of Objects into a Repr-format list containing those Objects.
     * Uses the Objects' toString() method.
     * 
     * @param <T>   Object
     * @param array An array of Objects.
     * @return A Repr-format String containing a List of all the Objects' String (or
     *         Repr, when available) forms.
     */
    ...
    /**
     * Turns a Collection of Objects into a Repr-format list containing those
     * Objects. Uses the Objects' toString() method.
     * 
     * @param <T>  Object
