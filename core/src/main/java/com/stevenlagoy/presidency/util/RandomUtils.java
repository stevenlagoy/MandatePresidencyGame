...
public final class RandomUtils {
    ...
    /**
     * Rolls the given number of dice with the given number of sides on each and
    ...
    /**
     * Rolls dice with the given numbers of sides and returns an array with the
     * results.
     */
     ...
     * 
     * @param <T>     Object
     * @param items   Ordered collection of selectable values. Must have same size
     *                as weights array.
     * @param weights Ordered collection of weights for each value. Must have same
     *                size as items array.
