...
/**
 * A convention call, or call of the convention, is an official document issued
 * by a political
 * party in the year before a party convention. It gives rules for primaries,
 * apportions delegates,
 * places the convention in a city on a certain date, and many other rules for
 * party conduct
...
public class ConventionCall {
    ...
    public ConventionCall(LocalDate issueDate, Party issuingParty, LocalDate conventionStartDate,
            Municipality conventionLocation) {
