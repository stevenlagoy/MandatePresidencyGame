...
import com.stevenlagoy.presidency.characters.PoliticalActor.Education;
...
public class PoliticalActor extends Character implements HasPersonality {
    ...
    public PoliticalActor(
        ...
        this(new Character(cm, dm, mm, nm, demographics, name, birthplaceMunicipality, currentLocationMunicipality, residenceMunicipality, birthday, appearance),
