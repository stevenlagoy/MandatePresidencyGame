...
import com.stevenlagoy.presidency.characters.attributes.HasPersonality;
...
public class PoliticalActor extends Character implements HasPersonality {
     ...
     */
    public PoliticalActor(CharacterManager cm, DemographicsManager dm, MapManager mm, NameManager nm) {
        this(new Character(cm, dm, mm, nm));
    }
     ...
     */
    public PoliticalActor(Character character, int cash, Education education, int[] alignments,
            List<Experience> experiences, Skills skills, List<Position> positions, Personality personality,
     ...
     *                                    will be added.
     * @see Character#Character(Demographics, Name, Municipality, Municipality,
     *      Municipality, Date, CharacterModel)
     * @see #PoliticalActor(Character, int, Education, int[], List, Skills, List,
     *      Personality, Role)
     */
    public PoliticalActor(CharacterManager cm, DemographicsManager dm, MapManager mm, NameManager nm,
            ...
            CharacterModel appearance, int cash, Education education, int[] alignments, List<Experience> experiences,
            Skills skills, List<Position> positions, Personality personality, Set<PoliticalRole> roles) {
        this(
                new Character(cm, dm, mm, nm, demographics, name, birthplaceMunicipality, currentLocationMunicipality,
                        residenceMunicipality, birthday, appearance),
