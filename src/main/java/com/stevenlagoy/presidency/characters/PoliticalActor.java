...
public class PoliticalActor extends Character implements HasPersonality {
     ...
     *      Personality, Role)
     */
    public PoliticalActor(Demographics demographics, Name name, Municipality birthplaceMunicipality,
        ...
        this(
                new Character(demographics, name, birthplaceMunicipality, currentLocationMunicipality,
