    ...
    public Demographics randomDemographics() {
        ...
        try {
            generation = demographicBlocs.get(DemographicCategory.GENERATION)
                    .get(RandomOperations.randInt(demographicBlocs.get(DemographicCategory.GENERATION).size() - 1));
            while (generation.getSubBlocs().size() != 0) {
                generation = generation.getSubBlocs()
                        .get(RandomOperations.randInt(generation.getSubBlocs().size() - 1));
            }
            religion = demographicBlocs.get(DemographicCategory.RELIGION)
                    .get(RandomOperations.randInt(demographicBlocs.get(DemographicCategory.RELIGION).size() - 1));
            ...
            raceEthnicity = demographicBlocs.get(DemographicCategory.RACE_ETHNICITY)
                    .get(RandomOperations.randInt(demographicBlocs.get(DemographicCategory.RACE_ETHNICITY).size() - 1));
            while (raceEthnicity.getSubBlocs().size() != 0) {
                raceEthnicity = raceEthnicity.getSubBlocs()
                        .get(RandomOperations.randInt(raceEthnicity.getSubBlocs().size() - 1));
            }
            presentation = demographicBlocs.get(DemographicCategory.PRESENTATION)
                    .get(RandomOperations.randInt(demographicBlocs.get(DemographicCategory.PRESENTATION).size() - 1));
