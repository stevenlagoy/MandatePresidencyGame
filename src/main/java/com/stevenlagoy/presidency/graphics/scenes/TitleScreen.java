...
public class TitleScreen implements ILogic {
    ...
    // List of entities
    private Entity[] entities = { titleScreenBackground, titleLogoContainer, titleLogo, buttonsContainer, newGameButton,
            loadGameButton, settingsButton, nudgeButton };
    private EntityType[] entityTypes = { EntityType.QUAD, EntityType.CONTAINER, EntityType.QUAD, EntityType.CONTAINER,
            EntityType.BUTTON, EntityType.BUTTON, EntityType.BUTTON, EntityType.BUTTON };
    // Positions of each entity, {Left, Top, Right, Bottom} or {X1, Y1, X2, Y2}
    private float[][] XYArrays = { { 0000f, 0000f, 2560f, 1440f }, { 0137f, 0087f, 0853f, 0355f },
            { 0167f, 0117f, 0823f, 0325f }, { 0137f, 0386f, 0853f, 0987f }, { 0197f, 0446f, 0793f, 0543f },
            { 0197f, 0574f, 0793f, 0671f }, { 0197f, 0702f, 0793f, 0799f }, { 0197f, 0830f, 0793f, 0927f } };
    // Layers which the entities belong on
    private int[] layers = { backgroundLayer, containerLayer, logoLayer, containerLayer, buttonLayer, buttonLayer,
            buttonLayer, buttonLayer };
    // Models for each entity
    private Model[] models = { null, null, null, null, null, null, null, null };
    // Textures for each entity
    private String[][] textureNames = { { "title_bg" }, { "container_base" }, { "title_logo" }, { "container_base" },
            { "new_game_button_bg", "new_game_button_hover_bg", "new_game_button_click_bg",
                    "new_game_button_click_bg" },
            { "load_game_button_bg", "load_game_button_hover_bg", "load_game_button_click_bg",
                    "load_game_button_click_bg" },
            { "title_settings_button_bg", "title_settings_button_hover_bg", "title_settings_button_click_bg",
                    "title_settings_button_click_bg" },
            { "title_nudge_button_bg", "title_nudge_button_hover_bg", "title_nudge_button_click_bg",
