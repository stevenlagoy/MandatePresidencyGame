...
public class NewGame implements ILogic {
    ...
    private EntityType[] entityTypes = { EntityType.ENTITY, EntityType.ENTITY, EntityType.CONTAINER,
            EntityType.CONTAINER, EntityType.BUTTON };
    private float[][] XYArrays = { { 0000f, 0000f, 2560f, 1440f }, { 0275f, 0000f, 1714f, 1440f },
            { 1747f, 32f, 2527f, 159f }, { 1747f, 0192f, 2527f, 1072f }, { 0023f, 0015f, 0253f, 0128f } };
