...
public class Material {
    ...
    public Material(Vector4f ambientColor, Vector4f diffuseColor, Vector4f specularColor, float reflectance,
            Texture texture, boolean hasTransparency) {
    ...
    public Material(Texture texture) {
        this(GraphicsManager.DEFAULT_COLOR, GraphicsManager.DEFAULT_COLOR, GraphicsManager.DEFAULT_COLOR, 0, texture,
                false);
    }
    ...
    public Material(Texture texture, float reflectance) {
        this(GraphicsManager.DEFAULT_COLOR, GraphicsManager.DEFAULT_COLOR, GraphicsManager.DEFAULT_COLOR, reflectance,
                texture, false);
    }
