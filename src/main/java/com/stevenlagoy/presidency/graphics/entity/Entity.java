...
public class Entity {
    ...
    public boolean intersects(Vector3f rayOrigin, Vector3f rayDirection) {
        ...
        Matrix4f transform = new Matrix4f().translate(pos).rotateXYZ(
                ...
                (float) Math.toRadians(rotation.z)).scale(scale);
    ...
    public static boolean rayIntersectsTriangle(Vector3f rayOrigin, Vector3f rayDir, Vector3f v0, Vector3f v1,
            Vector3f v2) {
