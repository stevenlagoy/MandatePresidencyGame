...
public class RenderManager {
    ...
    public static void renderLights(PointLight[] pointLights, SpotLight[] spotLights, DirectionalLight directionalLight,
            ShaderManager shader, Vector3f ambientLight, float specularPower) {
    ...
    public void render(Camera camera, SceneManager scene) {
        ...
        entityRenderer.render(camera, scene.getPointLights(), scene.getSpotLights(), scene.getDirectionalLight(),
                scene.getAmbientLight(), scene.getSpecularPower());
